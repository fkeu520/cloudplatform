...
(48, 0, '消息中心', '/message/list', 'Layout', 1, 'fas fa-bell', 160, 'message:list'),
(49, 48, '消息列表', '/message/list', 'message/list/index', 1, 'fas fa-bell', 1, 'message:list:view'),
(50, 49, '查看详情', NULL, NULL, 2, NULL, 0, 'message:list:detail'),
(51, 49, '删除消息', NULL, NULL, 2, NULL, 0, 'message:list:del'),
(52, 48, '渠道配置', '/message/channel', 'message/channel/index', 1, 'fas fa-wrench', 3, 'message:channel:list'),
...
(56, 48, '短信模板', '/message/template', 'message/template/index', 1, 'fas fa-sms', 4, 'message:template:list'),
...
(60, 48, '消息记录', '/message/record', 'message/record/index', 1, 'fas fa-list', 2, 'message:record:list'),
