...
-- =============================================================================
INSERT INTO sys_focus (id, tenant_id, name, sorting, status, create_by, create_time, deleted) VALUES
    (1, 1, '企业规模',  1, 1, 'system', '2026-07-01 10:00:00', 0),
    (2, 1, '企业类型',  2, 1, 'system', '2026-07-01 10:00:00', 0),
    (3, 1, '上市状态',  3, 1, 'system', '2026-07-01 10:00:00', 0),
    (4, 1, '科技资质',  4, 1, 'system', '2026-07-01 10:00:00', 0);

INSERT INTO sys_focus_item (id, tenant_id, focus_id, name, sorting, status, create_by, create_time, deleted) VALUES
    (1, 1, 1, '世界500强', 1, 1, 'system', '2026-07-01 10:00:00', 0),
    (2, 1, 1, '中国500强', 2, 1, 'system', '2026-07-01 10:00:00', 0),
    (3, 1, 1, '规模以上', 3, 1, 'system', '2026-07-01 10:00:00', 0),
    (4, 1, 2, '上市公司', 1, 1, 'system', '2026-07-01 10:00:00', 0),
    (5, 1, 2, '独角兽', 2, 1, 'system', '2026-07-01 10:00:00', 0),
    (6, 1, 2, '瞪羚企业', 3, 1, 'system', '2026-07-01 10:00:00', 0),
    (7, 1, 3, '已上市', 1, 1, 'system', '2026-07-01 10:00:00', 0),
    (8, 1, 3, '未上市', 2, 1, 'system', '2026-07-01 10:00:00', 0),
    (9, 1, 4, '高新技术企业', 1, 1, 'system', '2026-07-01 10:00:00', 0),
    (10, 1, 4, '专精特新', 2, 1, 'system', '2026-07-01 10:00:00', 0),
    (11, 1, 4, '技术先进型服务企业', 3, 1, 'system', '2026-07-01 10:00:00', 0);


-- =============================================================================
-- 2. 参考数据: 国民经济行业分类 (sys_enterprise_national_economy, 节选常用大类)
-- =============================================================================
...
INSERT INTO sys_enterprise (
    ...
    estiblish_time, from_time, to_time, approved_time,
    ...
    sort_order, status, is_sync, is_fill,
...
(1, 1,
 ...
 '任正非', 1, '1110',
 '4044093.8266', 'CNY', '4044093.8266', 'CNY',
 '1987-09-15 00:00:00', '1987-09-15 00:00:00', NULL, '2024-04-10 00:00:00',
 '广东省', '深圳市', '龙岗区', '深圳市龙岗区坂田街道华为基地', '深圳市市场监督管理局',
 '存续', '10000人以上', 156000, '一般经营项目是: 程控交换机、传输设备、数据通信设备、宽带多媒体设备、电源、无线通信设备、微电子产品、软件、系统集成工程、计算机及配套设备、终端设备及相关通信信息产品、化工产品(不含危险品)、光机电一体化产品、电子出版物、出口自研产品等',
...
(2, 1,
 ...
 '马化腾', 1, '1130',
 '2000000.00', 'CNY', '2000000.00', 'CNY',
 '1998-11-11 00:00:00', '1998-11-11 00:00:00', NULL, '2024-03-15 00:00:00',
 '广东省', '深圳市', '南山区', '深圳市南山区高新区科技中一路腾讯大厦35层', '深圳市市场监督管理局',
 '存续', '10000人以上', 112000, '一般经营项目是: 计算机软硬件的技术开发、销售技术服务;计算机及相关设备的安装、维护、租赁; 计算机网络工程的设计、施工;经营进出口业务;增值电信业务;信息服务业务',
...
(3, 1,
 ...
 '王传福', 1, '1210',
 '291114.2855', 'CNY', '291114.2855', 'CNY',
 '1995-02-10 00:00:00', '1995-02-10 00:00:00', NULL, '2024-05-08 00:00:00',
 '广东省', '深圳市', '坪山区', '深圳市坪山区比亚迪路3009号', '深圳市市场监督管理局',
 '存续', '10000人以上', 703500, '一般经营项目是: 汽车(含小轿车)的研发、生产、销售及售后服务; 锂离子电池、镍镉电池、镍氢电池、动力电池、储能电池及电池零配件的研发、生产、销售; 塑胶制品、五金制品的研发、生产、销售; 模具设计与制造;技术咨询和服务',
...
(4, 1,
 ...
 '戴珊', 1, '1130',
 '1590000.00', 'CNY', '1590000.00', 'CNY',
 '1999-09-09 00:00:00', '1999-09-09 00:00:00', NULL, '2024-02-20 00:00:00',
 '浙江省', '杭州市', '滨江区', '杭州市滨江区网商路699号', '浙江省市场监督管理局',
 '存续', '10000人以上', 124000, '一般经营项目是: 增值电信业务;计算机软硬件、网络技术、电子商务技术开发、技术服务、技术咨询、技术转让;计算机软硬件的销售; 设计、制作、代理、发布国内广告',
...
(5, 1,
 ...
 '曾毓群', 1, '1210',
 '439880.9536', 'CNY', '439880.9536', 'CNY',
 '2011-12-16 00:00:00', '2011-12-16 00:00:00', NULL, '2024-06-12 00:00:00',
 '福建省', '宁德市', '蕉城区', '宁德市蕉城区漳湾镇新港路2号', '宁德市市场监督管理局',
 '存续', '10000人以上', 138000, '一般经营项目是: 锂离子电池、锂聚合物电池、燃料电池、动力电池、超大容量储能电池及电池零配件的研发、生产、销售和服务; 锂电池及相关产品的技术服务、测试服务以及咨询服务',
...
-- =============================================================================
-- 4. 企业地址 (sys_enterprise_address, 1 row per enterprise)
-- =============================================================================
INSERT INTO sys_enterprise_address (
    id, tenant_id, enterprise_id, name, address, address_type, longitude, latitude,
    is_default, sort_order, status, create_by, create_time, deleted
) VALUES
(1, 1, 1, '华为深圳总部', '深圳市龙岗区坂田街道华为基地', 1, 114.0579, 22.5431, 1, 1, 1, 'system', '2026-07-01 10:00:00', 0),
(2, 1, 2, '腾讯滨海大厦', '深圳市南山区高新区科技中一路腾讯大厦', 1, 113.9388, 22.5344, 1, 1, 1, 'system', '2026-07-01 10:00:00', 0),
(3, 1, 3, '比亚迪坪山总部', '深圳市坪山区比亚迪路3009号', 1, 114.3564, 22.7089, 1, 1, 1, 'system', '2026-07-01 10:00:00', 0),
(4, 1, 4, '阿里巴巴滨江园', '杭州市滨江区网商路699号', 1, 120.2108, 30.2094, 1, 1, 1, 'system', '2026-07-01 10:00:00', 0),
(5, 1, 5, '宁德时代总部', '宁德市蕉城区漳湾镇新港路2号', 1, 119.5271, 26.6517, 1, 1, 1, 'system', '2026-07-01 10:00:00', 0);


-- =============================================================================
-- 5. 企业简介 (sys_enterprise_introduction)
-- =============================================================================
INSERT INTO sys_enterprise_introduction (
    id, tenant_id, enterprise_id, content, sort_order, status, create_by, create_time, deleted
) VALUES
(1, 1, 1, '华为创立于1987年,是全球领先的ICT(信息与通信)基础设施和智能终端提供商,致力于把数字世界带入每个人、每个家庭、每个组织,构建万物互联的智能世界。目前华为约有20.7万员工,业务遍及170多个国家和地区,服务全球30多亿人口。', 1, 1, 'system', '2026-07-01 10:00:00', 0),
(2, 1, 2, '腾讯成立于1998年,是中国最大的互联网综合服务提供商之一,也是中国服务用户最多的互联网企业之一。腾讯构建了覆盖游戏、社交、金融科技、云、广告等全方位的业务版图,旗下微信月活用户突破13亿。', 1, 1, 'system', '2026-07-01 10:00:00', 0),
(3, 1, 3, '比亚迪成立于1995年2月,总部位于广东省深圳市,是一家拥有IT、汽车及新能源三大产业群的高新技术民营企业。比亚迪于2002年7月31日在香港主板发行上市,于2011年6月30日在深圳证券交易所上市,目前是中国新能源汽车销量第一的车企。', 1, 1, 'system', '2026-07-01 10:00:00', 0),
(4, 1, 4, '阿里巴巴集团由马云等18人于1999年在杭州创立,经营多元化的互联网业务,涵盖电商、云计算、数字媒体、娱乐等。是全球最大的零售商业体,2024财年集团收入超过1万亿元人民币。', 1, 1, 'system', '2026-07-01 10:00:00', 0),
(5, 1, 5, '宁德时代新能源科技股份有限公司(简称"宁德时代",股票代码:300750)是中国率先具备国际竞争力的动力电池制造商之一,专注于新能源汽车动力电池系统、储能系统的研发、生产和销售。全球动力电池使用量市占率连续7年位居第一。', 1, 1, 'system', '2026-07-01 10:00:00', 0);
...
INSERT INTO sys_enterprise_register (
    id, tenant_id, enterprise_id, reg_no, reg_type, reg_capital, paid_capital,
    reg_address, reg_institute, reg_date, reg_status, business_term,
    legal_rep, sort_order, status, create_by, create_time, deleted
) VALUES
(1, 1, 1, '4403011029903889', '1110', '4044093.8266万元', '4044093.8266万元',
 '深圳市龙岗区坂田街道华为基地', '深圳市市场监督管理局', '1987-09-15', '存续', '长期',
 '任正非', 1, 1, 'system', '2026-07-01 10:00:00', 0),
(2, 1, 2, '440301501124589', '1130', '2000000.00万元', '2000000.00万元',
 '深圳市南山区高新区科技中一路腾讯大厦35层', '深圳市市场监督管理局', '1998-11-11', '存续', '长期',
 '马化腾', 1, 1, 'system', '2026-07-01 10:00:00', 0),
(3, 1, 3, '440301102920209', '1210', '291114.2855万元', '291114.2855万元',
 '深圳市坪山区比亚迪路3009号', '深圳市市场监督管理局', '1995-02-10', '存续', '长期',
 '王传福', 1, 1, 'system', '2026-07-01 10:00:00', 0),
(4, 1, 4, '330100000015384', '1130', '1590000.00万元', '1590000.00万元',
 '杭州市滨江区网商路699号', '浙江省市场监督管理局', '1999-09-09', '存续', '长期',
 '戴珊', 1, 1, 'system', '2026-07-01 10:00:00', 0),
(5, 1, 5, '350900100006128', '1210', '439880.9536万元', '439880.9536万元',
 '宁德市蕉城区漳湾镇新港路2号', '宁德市市场监督管理局', '2011-12-16', '存续', '长期',
 '曾毓群', 1, 1, 'system', '2026-07-01 10:00:00', 0);


-- =============================================================================
-- 7. 企业标签 (sys_enterprise_tag)
-- =============================================================================
INSERT INTO sys_enterprise_tag (id, tenant_id, enterprise_id, tag_name, tag_color, sort_order, status, create_by, create_time, deleted) VALUES
(1, 1, 1, '世界500强',    '#E74C3C', 1, 1, 'system', '2026-07-01 10:00:00', 0),
(2, 1, 1, '高新技术',    '#3498DB', 2, 1, 'system', '2026-07-01 10:00:00', 0),
(3, 1, 2, '中国500强',    '#E74C3C', 1, 1, 'system', '2026-07-01 10:00:00', 0),
(4, 1, 2, '互联网头部',   '#2ECC71', 2, 1, 'system', '2026-07-01 10:00:00', 0),
(5, 1, 3, '中国500强',    '#E74C3C', 1, 1, 'system', '2026-07-01 10:00:00', 0),
(6, 1, 3, '新能源汽车',   '#F39C12', 2, 1, 'system', '2026-07-01 10:00:00', 0),
(7, 1, 4, '中国500强',    '#E74C3C', 1, 1, 'system', '2026-07-01 10:00:00', 0),
(8, 1, 4, '电商龙头',    '#9B59B6', 2, 1, 'system', '2026-07-01 10:00:00', 0),
(9, 1, 5, '独角兽',      '#1ABC9C', 1, 1, 'system', '2026-07-01 10:00:00', 0),
(10, 1, 5, '动力电池龙头',  '#E67E22', 2, 1, 'system', '2026-07-01 10:00:00', 0);


-- =============================================================================
-- 8. 企业评分 (sys_rating, 默认 4 行规则, 租户 1)
-- =============================================================================
INSERT INTO sys_rating (id, tenant_id, level, overdue_min, overdue_max, debts_min, debts_max, date_num, date_unit, sort_order, status, create_by, create_time, deleted) VALUES
(1, 1, 1, 0, 0, 0, 0,    0, 'day', 1, 1, 'system', '2026-07-01 10:00:00', 0),
(2, 1, 2, 1, 2, 1, 5000,   30, 'day', 2, 1, 'system', '2026-07-01 10:00:00', 0),
(3, 1, 3, 3, 5, 5001, 50000, 60, 'day', 3, 1, 'system', '2026-07-01 10:00:00', 0),
(4, 1, 4, 6, 999, 50001, 9999999, 90, 'day', 4, 1, 'system', '2026-07-01 10:00:00', 0);


-- =============================================================================
-- 9. 企业关注标签关联 (sys_enterprise_focus, 1 row per enterprise)
-- =============================================================================
INSERT INTO sys_enterprise_focus (id, tenant_id, enterprise_id, focus_id, focus_name, focus_items, focus_item_names, status, create_by, create_time, deleted) VALUES
(1, 1, 1, 1, '企业规模',  '1',          '世界500强',                1, 'system', '2026-07-01 10:00:00', 0),
(2, 1, 2, 1, '企业规模',  '2',          '中国500强',                1, 'system', '2026-07-01 10:00:00', 0),
(3, 1, 3, 1, '企业规模',  '2',          '中国500强',                1, 'system', '2026-07-01 10:00:00', 0),
(4, 1, 4, 1, '企业规模',  '2',          '中国500强',                1, 'system', '2026-07-01 10:00:00', 0),
(5, 1, 5, 2, '企业类型',  '5',          '独角兽',                  1, 'system', '2026-07-01 10:00:00', 0);


-- =============================================================================
-- 10. 客户信息 (sys_customer_information, 1 row per enterprise, 已签约)
-- =============================================================================
INSERT INTO sys_customer_information (
    ...
    annual_revenue, total_assets, employee_count, tax_payment, intellectual_property_income,
    requirement_area, requirement_industries, requirement_special,
...
(1, 1, 1, 1, 'CUST-HW-001',   3, 50000.00, '深圳龙岗坂田基地A栋', NULL,
 ...
 '1987-09-15', 4044093.83, '120元/m²/月',
 5, 'ICT基础设施、智能终端、云服务',
 '1,2,9',  -- 世界500强, 中国500强, 高新技术企业
 95000, 35000, 25000, 8000, 12000, 18000,
 70420000.00, 102580000.00, 207000, 8850000.00, 25000000.00,
 5000, '通信,半导体,云计算,人工智能', '需配套研发实验室',
 1, 1, 'system', '2026-07-01 10:00:00', 0),
(2, 1, 1, 2, 'CUST-TX-001',   3, 35000.00, '深圳南山腾讯大厦', NULL,
 '马化腾', '0755-86013388', '13800000002', 'service@tencent.com',
 '1998-11-11', 2000000.00, '150元/m²/月',
 5, '社交、游戏、金融科技、云',
 '1,2,9',
 65000, 28000, 18000, 5500, 9500, 12000,
 60980000.00, 96800000.00, 112000, 7560000.00, 22000000.00,
 3000, '互联网,游戏,云计算,金融科技', '需数据中心配套',
 2, 1, 'system', '2026-07-01 10:00:00', 0),
(3, 1, 1, 3, 'CUST-BYD-001',  3, 80000.00, '深圳坪山比亚迪总部', NULL,
 '王传福', '0755-89888888', '13800000003', 'ir@byd.com',
 '1995-02-10', 291114.29, '90元/m²/月',
 4, '新能源汽车、动力电池、电子',
 '1,2',
 42000, 15000, 12000, 4000, 8000, 5000,
 60231500.00, 76320000.00, 703500, 6250000.00, 18000000.00,
 10000, '新能源汽车,锂电池,半导体', '需电池研发实验室',
 3, 1, 'system', '2026-07-01 10:00:00', 0),
(4, 1, 1, 4, 'CUST-ALB-001',  3, 60000.00, '杭州滨江阿里中心', NULL,
 '戴珊', '0571-85022088', '13800000004', 'ir@alibaba-inc.com',
 '1999-09-09', 1590000.00, '140元/m²/月',
 5, '电商、云计算、数字媒体',
 '1,2,9',
 38000, 12000, 9000, 3000, 7000, 7000,
 94116800.00, 130200000.00, 219260, 8120000.00, 30000000.00,
 5000, '电商,云计算,金融科技,物流', '需大型数据中心',
 4, 1, 'system', '2026-07-01 10:00:00', 0),
(5, 1, 1, 5, 'CUST-CATL-001', 3, 40000.00, '宁德蕉城基地', NULL,
 '曾毓群', '0593-2583666', '13800000005', 'catl@catlbattery.com',
 '2011-12-16', 439880.95, '100元/m²/月',
 4, '动力电池、储能电池',
 '1,5,9',  -- 中国500强, 独角兽, 高新技术
 18500, 8500, 5000, 1500, 2500, 1000,
 40091700.00, 62760000.00, 138000, 5480000.00, 15000000.00,
 3000, '动力电池,储能,新能源', '需电池中试线配套',
 5, 1, 'system', '2026-07-01 10:00:00', 0);


-- =============================================================================
-- 11. 行业类型 (sys_enterprise_industry, 5 行业示例)
-- =============================================================================
...
-- =============================================================================
-- 12. 云企库数据 - 经营风险 (sys_enterprise_cloud_data, business_risk)
-- =============================================================================
...
-- =============================================================================
-- 13. 云企库数据 - 司法风险 (sys_enterprise_cloud_data, judicial_risk)
-- =============================================================================
INSERT INTO sys_enterprise_cloud_data (id, tenant_id, enterprise_id, enterprise_name, category, data_content, data_year, data_date, sort_order, status, remark, create_by, create_time, deleted) VALUES
...
-- =============================================================================
-- 14. 云企库数据 - 经营状况 (sys_enterprise_cloud_data, business_situation)
-- =============================================================================
INSERT INTO sys_enterprise_cloud_data (id, tenant_id, enterprise_id, enterprise_name, category, data_content, data_year, data_date, sort_order, status, remark, create_by, create_time, deleted) VALUES
...
-- =============================================================================
-- 15. 云企库数据 - 企业详情 (sys_enterprise_cloud_data, ent_detail)
-- =============================================================================
INSERT INTO sys_enterprise_cloud_data (id, tenant_id, enterprise_id, enterprise_name, category, data_content, data_year, data_date, sort_order, status, remark, create_by, create_time, deleted) VALUES
...
-- =============================================================================
-- 16. 云企库数据 - 知识 (sys_enterprise_cloud_data, knowledge)
-- =============================================================================
INSERT INTO sys_enterprise_cloud_data (id, tenant_id, enterprise_id, enterprise_name, category, data_content, data_year, data_date, sort_order, status, remark, create_by, create_time, deleted) VALUES
...
-- =============================================================================
-- 17. 企业概览数据 (sys_enterprise_overview_data)
-- =============================================================================
