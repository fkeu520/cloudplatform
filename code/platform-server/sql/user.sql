...
-- 根组织
INSERT INTO `sys_organization` (`id`, `parent_id`, `name`, `code`, `type`, `sort`, `status`, `tenant_id`) VALUES
(1, 0, '云枢科技', 'CLOUDHUB', 1, 0, 1, 1);

-- 初始管理员
INSERT INTO `sys_user` (`id`, `username`, `password`, `nickname`, `mobile`, `email`, `status`, `tenant_id`) VALUES
(1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', '系统管理员', '13800138000', 'admin@cloudhub.com', 1, 1);

-- 基础角色
INSERT INTO `sys_role` (`id`, `code`, `name`, `sort`, `remark`, `tenant_id`) VALUES
...
(14, 0, '基础配置', '/base', 'Layout', 1, 'Grid', 200, ''),
(15, 14, '字典管理', '/system/dict', 'system/dict/index', 1, 'Notebook', 1, 'system:dict:list'),
...
(20, 14, '参数配置', '/system/config', 'system/config/index', 1, 'Setting', 2, 'system:config:list'),
