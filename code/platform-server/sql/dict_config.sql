...
INSERT INTO `sys_dict_type` (`id`, `dict_name`, `dict_type`, `status`, `remark`, `tenant_id`) VALUES
(1, 'User Gender', 'sys_user_gender', 1, 'user gender dict', 1),
(2, 'Common Status', 'sys_normal_status', 1, 'enable/disable status', 1);

INSERT INTO `sys_dict_data` (`id`, `dict_type`, `dict_label`, `dict_value`, `dict_sort`, `status`, `css_class`) VALUES
