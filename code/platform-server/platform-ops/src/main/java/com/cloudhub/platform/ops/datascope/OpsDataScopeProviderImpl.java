...
/**
 * platform-ops 模块 DataScopeProvider (M5+ Provider 真实现, 2026-06-18)
 *
...
@Slf4j
@Service
public class OpsDataScopeProviderImpl extends HttpDataScopeProvider {

    public OpsDataScopeProviderImpl(@Qualifier("loadBalancedRestTemplate") RestTemplate restTemplate) {
        super(restTemplate);
    }
}
