...
public class WorkflowDataScopeProviderImpl implements DataScopeProvider {

    @Override
    public DataScopeContext getContext(Long userId) {
        // platform-workflow 桩: 返回 none() (无 data_scope 限制)
        // 实际场景: 流程模块跨部门协作多, 暂不限制
        log.debug("WorkflowDataScopeProviderImpl.getContext: userId={}, return none()", userId);
